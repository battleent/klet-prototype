    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div style={{ display: 'flex', marginTop: '20px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <input placeholder="이름" style={{ width: '150px' }} {...register("name")} />
                    <input type="date" placeholder="생년월일" style={{ width: '150px' }} {...register("date")} />
                    ...
                    <input type="email" placeholder="이메일" style={{ width: '150px' }} {...register("email")} />
                </div>
            </div>
